...
let triviaArr = [];
  ...
  triviaArr.push(axios.get(`https://pokeapi.co/api/v2/pokemon/${Math.floor(Math.random()*Math.floor(81)) + 721}`).then(results => {
  ...
  if(results.data.name === 'rowlet'){
    pokeBio.innerHTML = '';
      ...
      pokeBio.innerHTML = ""
  } else if(results.data.name === 'lycanroc'){
      pokeBio.innerHTML = ""
  } else if(results.data.name === 'wishiwashi'){
      pokeBio.innerHTML = ""
      ...
      pokeBio.innerHTML = ""
  } else if(results.data.name === 'minior'){
      pokeBio.innerHTML = ""
      ...
      pokeBio.innerHTML = ""
  } else if(results.data.name === 'mimikyu'){
      pokeBio.innerHTML = ""
